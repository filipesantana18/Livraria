...
public class notacompra extends javax.swing.JDialog {
   ...
   private float preco;
    ...
    /** Creates new form notacompra */
    public notacompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
query+="compra as v where i.cod_compra=v.cod_compra and i.cod_produto=p.cod_produto and i.cod_compra="+(cod_compra);
